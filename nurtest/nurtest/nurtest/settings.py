"""
Django settings for nurtest project.
...
WSGI_APPLICATION = 'nurtest.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'kulzhanofff@mail.ru'  # Ваша почта Mail.ru
